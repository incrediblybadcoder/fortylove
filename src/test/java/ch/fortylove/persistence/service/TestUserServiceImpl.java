...
class TestUserServiceImpl {
    ...
    public void testCreate() {
        ...
        final User createdUser = testee.create(new User(0L, "firstName", "lastName", "email@fortylove.ch", "password", true, Arrays.asList(role1, role2), null));
    ...
    public void testFindByEmail_notExists() {
        ...
        final Role role1 = roleService.create(new Role(0L, "roleName1", null, List.of(privilege1)));
        final Role role2 = roleService.create(new Role(0L, "roleName2", null, List.of(privilege2)));
        testee.create(new User(0L, "firstName1", "lastName1", "email1@fortylove.ch", "password1", true, Arrays.asList(role1, role2), null));
        testee.create(new User(0L, "firstName3", "lastName3", "email3@fortylove.ch", "password3", true, Arrays.asList(role1, role2), null));
    ...
    public void testFindByEmail_exists() {
        ...
        final Role role2 = roleService.create(new Role(0L, "roleName2", null, List.of(privilege2)));
        testee.create(new User(0L, "firstName1", "lastName1", "email1@fortylove.ch", "password1", true, Arrays.asList(role1, role2), null));
        final User user2 = testee.create(new User(0L, "firstName2", "lastName2", "email2@fortylove.ch", "password2", true, Arrays.asList(role1, role2), null));
        testee.create(new User(0L, "firstName3", "lastName3", "email3@fortylove.ch", "password3", true, Arrays.asList(role1, role2), null));
