 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ut,mt,ht,pt;const L=window,g=o=>{L.emitLitDebugLogEvents&&L.dispatchEvent(new CustomEvent("lit-debug",{detail:o}))};let sn=0,Ke;(ut=L.litIssuedWarnings)!==null&&ut!==void 0||(L.litIssuedWarnings=new Set),Ke=(o,e)=>{e+=o?` See https://lit.dev/msg/${o} for more information.`:"",L.litIssuedWarnings.has(e)||(console.warn(e),L.litIssuedWarnings.add(e))},Ke("dev-mode","Lit is in dev mode. Not recommended for production!");const P=!((mt=L.ShadyDOM)===null||mt===void 0)&&mt.inUse&&((ht=L.ShadyDOM)===null||ht===void 0?void 0:ht.noPatch)===!0?L.ShadyDOM.wrap:o=>o,ue=L.trustedTypes,fo=ue?ue.createPolicy("lit-html",{createHTML:o=>o}):void 0,an=o=>o,Xe=(o,e,t)=>an,ln=o=>{if(oe!==Xe)throw new Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");oe=o},cn=()=>{oe=Xe},Nt=(o,e,t)=>oe(o,e,t),Lt="$lit$",W=`lit$${String(Math.random()).slice(9)}$`,jo="?"+W,dn=`<${jo}>`,ee=document,_e=()=>ee.createComment(""),Se=o=>o===null||typeof o!="object"&&typeof o!="function",Wo=Array.isArray,un=o=>Wo(o)||typeof(o==null?void 0:o[Symbol.iterator])=="function",ft=`[ 	
\f\r]`,mn=`[^ 	
\f\r"'\`<>=]`,hn=`[^\\s"'>=/]`,ge=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,go=1,gt=2,pn=3,vo=/-->/g,bo=/>/g,X=new RegExp(`>|${ft}(?:(${hn}+)(${ft}*=${ft}*(?:${mn}|("|')|))|$)`,"g"),fn=0,yo=1,gn=2,xo=3,vt=/'/g,bt=/"/g,Go=/^(?:script|style|textarea|title)$/i,vn=1,Ye=2,Mt=1,Je=2,bn=3,yn=4,xn=5,Dt=6,wn=7,qo=o=>(e,...t)=>(e.some(i=>i===void 0)&&console.warn(`Some template strings are undefined.
This is probably caused by illegal octal escape sequences.`),{_$litType$:o,strings:e,values:t}),R=qo(vn),_r=qo(Ye),te=Symbol.for("lit-noChange"),S=Symbol.for("lit-nothing"),wo=new WeakMap,Q=ee.createTreeWalker(ee,129,null,!1);let oe=Xe;const _n=(o,e)=>{const t=o.length-1,i=[];let n=e===Ye?"<svg>":"",r,s=ge;for(let a=0;a<t;a++){const c=o[a];let u=-1,p,h=0,f;for(;h<c.length&&(s.lastIndex=h,f=s.exec(c),f!==null);)if(h=s.lastIndex,s===ge){if(f[go]==="!--")s=vo;else if(f[go]!==void 0)s=bo;else if(f[gt]!==void 0)Go.test(f[gt])&&(r=new RegExp(`</${f[gt]}`,"g")),s=X;else if(f[pn]!==void 0)throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else s===X?f[fn]===">"?(s=r??ge,u=-1):f[yo]===void 0?u=-2:(u=s.lastIndex-f[gn].length,p=f[yo],s=f[xo]===void 0?X:f[xo]==='"'?bt:vt):s===bt||s===vt?s=X:s===vo||s===bo?s=ge:(s=X,r=void 0);console.assert(u===-1||s===X||s===vt||s===bt,"unexpected parse state B");const G=s===X&&o[a+1].startsWith("/>")?" ":"";n+=s===ge?c+dn:u>=0?(i.push(p),c.slice(0,u)+Lt+c.slice(u)+W+G):c+W+(u===-2?(i.push(void 0),a):G)}const l=n+(o[t]||"<?>")+(e===Ye?"</svg>":"");if(!Array.isArray(o)||!o.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pn={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},zn=o=>(...e)=>({_$litDirective$:o,values:e});class On{constructor(e){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(e,t,i){this.__part=e,this._$parent=t,this.__attributeIndex=i}_$resolve(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Mn extends On{constructor(e){var t;if(super(e),e.type!==Pn.ATTRIBUTE||e.name!=="class"||((t=e.strings)===null||t===void 0?void 0:t.length)>2)throw new Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var i,n;if(this._previousClasses===void 0){this._previousClasses=new Set,e.strings!==void 0&&(this._staticClasses=new Set(e.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in t)t[s]&&!(!((i=this._staticClasses)===null||i===void 0)&&i.has(s))&&this._previousClasses.add(s);return this.render(t)}const r=e.element.classList;this._previousClasses.forEach(s=>{s in t||(r.remove(s),this._previousClasses.delete(s))});for(const s in t){const l=!!t[s];l!==this._previousClasses.has(s)&&!(!((n=this._staticClasses)===null||n===void 0)&&n.has(s))&&(l?(r.add(s),this._previousClasses.add(s)):(r.remove(s),this._previousClasses.delete(s)))}return te}}const Ko=zn(Mn),Ct="css-loading-indicator";var O;(function(o){o.IDLE="",o.FIRST="first",o.SECOND="second",o.THIRD="third"})(O||(O={}));class C extends ie{constructor(){super(),this.firstDelay=450,this.secondDelay=1500,this.thirdDelay=5e3,this.expandedDuration=2e3,this.onlineText="Online",this.offlineText="Connection lost",this.reconnectingText="Connection lost, trying to reconnect...",this.offline=!1,this.reconnecting=!1,this.expanded=!1,this.loading=!1,this.loadingBarState=O.IDLE,this.applyDefaultThemeState=!0,this.firstTimeout=0,this.secondTimeout=0,this.thirdTimeout=0,this.expandedTimeout=0,this.lastMessageState=E.CONNECTED,this.connectionStateListener=()=>{this.expanded=this.updateConnectionState(),this.expandedTimeout=this.timeoutFor(this.expandedTimeout,this.expanded,()=>{this.expanded=!1},this.expandedDuration)}}static create(){var e,t;const i=window;return!((e=i.Vaadin)===null||e===void 0)&&e.connectionIndicator||(i.Vaadin=i.Vaadin||{},i.Vaadin.connectionIndicator=document.createElement("vaadin-connection-indicator"),document.body.appendChild(i.Vaadin.connectionIndicator)),(t=i.Vaadin)===null||t===void 0?void 0:t.connectionIndicator}render(){return R`
...
`,x=class extends ie{constructor(){super(),this.expanded=!1,this.messages=[],this.notifications=[],this.frontendStatus="unavailable",this.javaStatus="unavailable",this.tabs=[{id:"log",title:"Log",render:this.renderLog,activate:this.activateLog},{id:"info",title:"Info",render:this.renderInfo},{id:"features",title:"Feature Flags",render:this.renderFeatures}],this.activeTab="log",this.serverInfo={flowVersion:"",vaadinVersion:"",javaVersion:"",osVersion:"",productName:""},this.features=[],this.unreadErrors=!1,this.componentPickActive=!1,this.nextMessageId=1,this.transitionDuration=0,window.Vaadin.Flow&&this.tabs.push({id:"code",title:"Code",render:this.renderCode})}static get styles(){return[y`
    ...
    `}render(){return R` <div
      ...
      <div>
        ...
        <button
          class="button pick"
          @click=${()=>{this.componentPickActive=!0,He(()=>import("./component-picker-dc3a2c57.js"),[],import.meta.url)}}
        >
...
`,ii=document.createElement("template");ii.innerHTML=`<style>${ar.toString().replace(":host","html")}</style>`;document.head.appendChild(ii.content);const ni=y`
  [theme~='dark'] {
    /* Base (background) */
...
${gr}
${vr}
`;ke("",ci,{moduleId:"lumo-utility"});const br=y`:host{background-color:var(--lumo-shade-5pct)!important;--vaadin-app-layout-navbar-background: var(--lumo-base-color)}[part=content]{height:100%}[part=navbar]{z-index:200;box-shadow:0 0 16px 2px var(--lumo-shade-20pct)}@media (max-height: 600px){:host(.hide-navbar) [part=navbar]{display:none}}[part=navbar]{align-items:center;justify-content:center}[part=navbar]:after{content:""}[part=navbar] ::slotted(*:first-child),[part=navbar]:after{flex:1 0 .001px}@media (max-width: 800px){[part=navbar] ::slotted(vaadin-tabs){max-width:100%!important}[part=navbar] ::slotted(.hide-on-mobile){display:none}[part=navbar]:after{content:none}vaadin-app-layout vaadin-tab{font-size:var(--lumo-font-size-xs);padding-left:.75em;padding-right:.75em;cursor:pointer}vaadin-app-layout vaadin-tab a:hover{text-decoration:none}vaadin-app-layout vaadin-tab:not([selected]) a{color:var(--lumo-contrast-60pct)}vaadin-app-layout vaadin-tabs{max-width:65%}@media (min-width: 700px){vaadin-app-layout vaadin-tab{font-size:var(--lumo-font-size-m);padding-left:1em;padding-right:1em}}vaadin-app-layout vaadin-tab vaadin-icon{margin:0 4px;width:var(--lumo-icon-size-m);height:var(--lumo-icon-size-m);padding:.25rem;box-sizing:border-box!important}}
`,be=(o,e)=>{const t=document.createElement("style");t.type="text/css",t.appendChild(document.createTextNode(o)),e===document?document.head.appendChild(t):e.appendChild(t)};window.Vaadin=window.Vaadin||{};window.Vaadin.theme=window.Vaadin.theme||{};window.Vaadin.theme.injectedGlobalCss=[];const yr=o=>{document._vaadintheme_fortylove_componentCss||(ke("vaadin-app-layout",Vo(br.toString())),document._vaadintheme_fortylove_componentCss=!0),be(ti.cssText,o),be(ni.cssText,o),be(ri.cssText,o),be(li.cssText,o),be(ci.cssText,o)},xr=yr;xr(document);export{On as D,ie as L,Pn as P,Er as T,Qn as a,Fe as b,y as c,te as d,zn as e,ni as f,Qo as g,R as h,_ as i,fe as j,S as n,Xn as p,In as q,ke as r,_r as s,ti as t,Vo as u};
